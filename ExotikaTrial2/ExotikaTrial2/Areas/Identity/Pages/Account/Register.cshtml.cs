...
namespace ExotikaTrial2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (user.Role == SD.Role_User_Tourist)
                    {
                        var touristUser = new Tourist()
                        {
                            TouristId = user.Id,
                            Name = user.Name,
                            StreetAddress = user.StreetAddress,
                    ...
                    {
                        if (user.Role == SD.Role_User_Resort)
                        {
                            var resortUser = new Resort()
                            {
                                ResortId = user.Id,
                                Name = user.Name,
                                StreetAddress = user.StreetAddress,
                        ...
                        {
                            if (user.Role == SD.Role_User_Vendor)
                            {
                            ...
                            {
                                if (user.Role == SD.Role_User_HandicraftDealer)
                                {
                                    var handicraftDealerUser = new HandicraftDealer()
                                    {
                                        HandicraftDealerId = user.Id,
                                        Name = user.Name,
                                        StreetAddress = user.StreetAddress,
                                        City = user.City,
                                        State = user.State,
